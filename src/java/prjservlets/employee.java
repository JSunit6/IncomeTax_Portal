...
public class employee extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String emp=request.getParameter("btnemp");

        if(emp.equals("ADD EMPLOYEE DETAILS"))
        {
            response.sendRedirect("addemp.jsp");
        }
        else if (emp.equals("UPDATE EMPLOYEE DETAILS"))
        {
             response.sendRedirect("updateemp.jsp");
        }
        else if(emp.equals("DELETE EMPLOYEE DETAILS"))
        {
             response.sendRedirect("empdelete.jsp");
        }
        else if(emp.equals("VIEW EMPLOYEE DETAILS"))
        {
