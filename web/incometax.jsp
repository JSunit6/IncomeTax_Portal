...
a:active {color:white;}
        ...
        <script>
            function enable()
    {
       var x=document.incform.dellst.selectedIndex;
            if(x==0)
            {
...
<h2>OUR PARTNERS</h2>
 ...
 <li><a href="www.lic.com"><img src="images/lic.jpg" width="196" height="137"/></a></li>
  ...
  <li><a href="www.newindia.com"><img src="images/new india.jpg" width="181" height="155" /></a></li>
                       ...
                       <div id="content">
		<div class="incometax"><img src="images/calculateincome.jpg" alt="" width="730" height="270" /></div>
                <%!
                Connection con;
                Statement stmt;
                ResultSet rs;
...
%>              <form name="incform" method="post" action="incometax">
                <center>
                    <font size="6">INCOME TAX</font><br/><br/><br/><br/><br/><br/>
                    <font size="4" color="ochure yellow" style="font-weight: bolder">
                        SELECT EMPLOYEE NAME :&nbsp;<select name="dellst" style="width: 100px" onclick="return enable()">
      ...
      <%
        ...
        <option><%=rs.getString(2)%></option>
           ...
           <br/><br/><br/>
           <input id="view" type="submit" value="CALCULATE INCOME TAX" name="btnname" disabled="true"/><br/><br/><br/>
           <input id="delete" type="submit" value="DELETE INCOME TAX DETAILS" name="btnname" disabled="true"/>
                </center>
                       </form>
                       </div>
