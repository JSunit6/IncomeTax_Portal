 ...
 <h2>OUR PARTNERS</h2>
  ...
  <li><a href="www.lic.com"><img src="images/lic.jpg" width="196" height="137"/></a></li>
   ...
   <li><a href="www.newindia.com"><img src="images/new india.jpg" width="181" height="155" /></a></li>
 	...
 	<!-- start content -->
		<div id="content">
 		<div class="incometax"><img src="images/reports.jpg" alt="" width="730" height="270" /></div>
 		<br>
                <br>
                <center><font size="6">REPORTS</font></center>
                <br>
                <br>
                    <form name="myform" method="post" action="reports">
                             <font color="#990000" size="3">
                                 <table border="0" align="center">
                           <tr><td> <input type="submit" value="VIEW INCOME TAX REPORT" name="btnreports" style="width: 210px"/></td></tr>

                            <tr></tr>
                            <tr></tr>
                            <tr></tr>
                            <tr><td><input type="submit" value="VIEW EMPLOYEE REPORT" name="btnreports" style="width: 210px"/></td></tr>

                          <tr></tr>
                          <tr></tr>
                          <tr></tr>
                            <tr><td><input type="submit" value="VIEW INVESTMENT REPORT" name="btnreports" style="width: 210px"/></td></tr>
